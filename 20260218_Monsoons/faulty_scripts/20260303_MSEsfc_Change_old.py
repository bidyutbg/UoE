...
# Physical constants
# =========================
Cp = 1005.0    # J kg-1 K-1  (specific heat of air at constant pressure)
...
for model_name, model_meta in MODELS.items():
    ...
    for exp, meta in EXPERIMENTS.items():
        ...
        da_tas = da_tas.drop_vars("height", errors="ignore")   # ← add this. 
                                                               # CMIP6 issue — some models attach a height scalar coordinate to tas 
                                                               # (e.g. "2 metres") and others don't, causing xr.concat to fail. 
                                                               # Fix it by dropping height if present
